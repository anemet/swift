...
private:
  ...
  std::unique_ptr<llvm::yaml::Output> OptRecordFile;
...
public:
  ...
  llvm::yaml::Output *getOptRecordFile() {
    return OptRecordFile.get();
  }
  void setOptRecordFile(std::unique_ptr<llvm::yaml::Output> &&O);
